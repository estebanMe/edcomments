...
func login(w http.ResponseWriter, r *http.Request) {
	...
	if user.ID > 0 {
		...
		if err != nil {
			log.Fatalf("Error al convertir el tojen a json: %s", err)
		}
...
//UserCreate allows to register a user
